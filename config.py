...
class Config(object):
    ...
    SQL_SERVER = os.environ.get('SQL_SERVER') or 'tridang.database.windows.net'
    SQL_DATABASE = os.environ.get('SQL_DATABASE') or 'Article CMS'
    SQL_USER_NAME = os.environ.get('SQL_USER_NAME') or 'trident'
    ...
    CLIENT_SECRET = "wHG8Q~pYSGs-96Jk0_2703z9Ohwrhqw7BBPqyb9X"
    ...
    CLIENT_ID = "4ccb95e0-b657-4f77-aa3a-e31da0951013"
